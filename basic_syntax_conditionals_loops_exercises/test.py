...
#     remaining_budget += one_bread_price
#
# print(f"You made {bread_counter} loaves of Easter bread! Now you have {colored_eggs_counter - current_bread_counter} eggs and {budget - remaining_budget:.2f}BGN left.")
